...
- **Group access control** — a brand-new group is gated until the admin vouches for it. Auto-approved when the admin adds the bot to the group (WhatsApp), when the admin speaks in it, or via `/allow <group-id>`
